...
const quickActions: { icon: IconName; text: string; url: string; color: string; bg: string }[] = [
  ...
  { icon: 'mine', text: '供应商管理', url: '/pages/suppliers/index', color: '#16a34a', bg: 'rgba(22,163,74,0.14)' },
  ...
  { icon: 'records', text: '账本流水', url: '/pages/ledger/index', color: '#7c3aed', bg: 'rgba(124,58,237,0.14)' },
  { icon: 'records', text: '客户订单', url: '/pages/orders/index', color: '#0891b2', bg: 'rgba(8,145,178,0.14)' },
